<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExamList.aspx.cs" Inherits="GradeManger_ExamList" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#turnTo").click(function () {
                ...
                window.location.href = "ExamList.aspx?pageNumber=" + targetPage;
            })
            ...
            <div id="content">
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="GradeInfoManger.aspx?TheExamId=<%= item.TheExamId %>"><%= item.TheExamName %></a></td>
