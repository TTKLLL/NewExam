...
public partial class GradeManger_GradeInfoManger : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack == true)
        {
            ...
            if (Request.QueryString["TheExamId"] != null)
            {
                ...
                if (new ExamBLL().GetChoseExamType() == 2)  //实践考试
                    Response.Redirect("PracticalGradeInfoManger.aspx?TheExamId=" + TheExamId);
            }
    ...
    {
        Query = tb_Query.Text;
        Response.Redirect("GradeInfoManger.aspx?Query=" + Query + "&Page=" + lblCurrentPage.Text);
    }
