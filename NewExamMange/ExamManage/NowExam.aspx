<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NowExam.aspx.cs" Inherits="ExamManage_NowExam" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#prev").click(function () {
                ...
                window.location = "NowExam.aspx?pageNumber=" + page + "&para=" + $("#para").val();
            ...
            $("#next").click(function () {
                var page = parseInt(<%= pageNumber+1%>)
                window.location.href = "NowExam.aspx?pageNumber=" + page + "&para=" + $("#para").val();

            })

            //查询
            $("#querty_btn").click(function () {
                window.location.href = "NowExam.aspx?pageNumber=" + 1 + "&para=" + $("#para").val();
            })
            ...
            $("#turnTo").click(function () {
                ...
                window.location.href = "NowExam.aspx?pageNumber=" + targetPage + "&para=" + $("#para").val();
            })
            ...
            $(".checkStu").click(function () {
                ...
                var page = parseInt(<%= pageNumber+1%>)
                window.location.href = "NowExam.aspx?pageNumber=" + page
...
<body>
    <form id="form1" action="NowExam.aspx" method="post" runat="server">
        <div>
            ...
            <div style="margin-bottom: 10px; padding: 8px 0 8px 15px; background-color: #F5F5F5">
                ...
                <a href="" style="color: red">正在进行的考试</a>
            </div>
