    ...
    <form id="form1" runat="server">
        <div>
            <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
                <li ><a style="color: red" href="WaitAuditManage.aspx">待审核考生</a></li>
                <li><a href="PassAuditManage.aspx">审核通过考生</a></li>
                <li class="active" ><a style="color: red" href="FailAuditManage.aspx">审核不通过考生</a></li>
            </ul>
        ...
        <button class="btn btn-primary" style="margin-left: 5px;">通过审核</button>
