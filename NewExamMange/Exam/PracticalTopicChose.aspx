<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PracticalTopicChose.aspx.cs" Inherits="Exam_Default" %>
...
<body>
    <form id="form1" runat="server">
        <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
            <li class="active"><a style="color: red" href="">已选题目</a></li>
            <li><a href="PracticalTopicNoChose .aspx">未选题目</a></li>
        </ul>
