<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddStudent.aspx.cs" Inherits="Admin_ManageStu_AddStudent" %>
...
<body>
    <form id="form1" runat="server" action="AddStudent.aspx" method="post" enctype="multipart/form-data">
        <div>
            <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
                ...
                <li class="active"><a style="color: red" href="AddStudent.aspx">考生信息采集</a></li>
            </ul>
