<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FailAuditManage.aspx.cs" Inherits="AuditManage_FailAuditManage" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#prev").click(function () {
                ...
                window.location = "FailAuditManage.aspx?pageNumber=" + page + "&para=" + $("#para").val();
            ...
            $("#next").click(function () {
                var page = parseInt(<%= pageNumber+1%>)
                window.location.href = "FailAuditManage.aspx?pageNumber=" + page + "&para=" + $("#para").val();
            ...
            $("#turnTo").click(function () {
                ...
                window.location.href = "FailAuditManage.aspx?pageNumber=" + targetPage + "&para=" + $("#para").val();
            })
            ...
            $("#outPut").click(function () {
                ...
                window.location.href = "OutPutSut.ashx?para=" + $("#para").val() + "&state=0&fileName=未通过审核考生信息";
    ...
    <form id="form1" runat="server">
        <div>
            <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
                ...
                <li class="active"><a style="color: red" href="FailAuditManage.aspx">未通过审核考生</a></li>
            ...
            <div>
                ...
                <button type="button" id="admit" class="btn btn-primary btn-sm">返回待审核</button>&nbsp;
                <%-- <button type="button" id="refuse" class="btn btn-primary btn-sm">审核不通过</button>&nbsp;--%>
