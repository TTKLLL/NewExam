<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminInfo.aspx.cs" Inherits="TeacherManage_AdminInfo" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <a href="" style="color: red">教师信息管理</a>--%>
                ...
                <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
                    ...
                    <li><a href="ExamTeacher.aspx">监考老师</a></li>
                    <li class="active"><a style="color: red" href="AdminInfo.aspx">管理员</a></li>
                    ...
                    <asp:Panel ID="Panel2" runat="server" Visible="false">
                        <table class="table table-bordered table-condensed border-striped">
                            <tr class="info" style="font-weight: bolder;">
                                ...
                                <%--   <td style="width: 10%;">工作职责</td>--%>
                                <td style="width: 15%;">教师在岗状态</td>
                                <%-- <td style="width: 15%;">是否为监考老师</td>--%>
                            </tr>
                        </table>
                        <span style="margin-left: 20px; font-weight: 400;">
                            <asp:Label ID="Label4" runat="server" Text="暂无数据"></asp:Label></span>
                    ...
                    <asp:Repeater OnItemDataBound="rp_TeacherInfo_ItemDataBound" ID="rp_TeacherInfo" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("TPhone")%></td>
                                <%--<td><%# GetAuditStatus(int.Parse(Eval("TId").ToString())) %></td>--%>

                                <td>
                                    <asp:CheckBox ID="ck2" runat="server" AutoPostBack="true" OnCheckedChanged="ck2_CheckedChanged" />
                                    <asp:Label Visible="false" ID="Label2" runat="server" Text='<%# Eval("IsAdmin") %>'></asp:Label>
                                    <asp:Label ID="Label3" Visible="false" runat="server" Text='<%#Eval("TId")%>'></asp:Label>
                                    <asp:Label Visible="false" ID="IsExamTeacher_lb" runat="server" Text='<%# Eval("isExamTeacher") %>'></asp:Label>
                                </td>
                                <%--    <td>
