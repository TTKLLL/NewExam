<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageTeacher.aspx.cs" Inherits="ManageTeacher" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <a href="" style="color: red">教师信息管理</a>--%>
                ...
                <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
                    <li class="active"><a style="color: red" href="ManageTeacher.aspx">教师</a></li>
                        ...
                        <ItemTemplate>
                            <tr >
                                ...
                                <td>
                                    ...
                                    <asp:Label Visible="false" ID="Label2" runat="server" Text='<%# Eval("TeacherState") %>'></asp:Label>
                                    <asp:Label ID="Label3" Visible="false" runat="server" Text='<%# Eval("TId")%>'></asp:Label>

                                    <asp:Label Visible="false" ID="IsExamTeacher_lb" runat="server" Text='<%# GetAuditStatus( int.Parse(Eval("IsAdmin").ToString())) %>'></asp:Label>
                                </td>
                            ...
                            <table id="queryTab" style="line-height: 50px;" class="table table-bordered table-condensed">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="AddTeacher.aspx" class="btn btn-primary">新建</a>
