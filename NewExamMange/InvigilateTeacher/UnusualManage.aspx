<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="UnusualManage.aspx.cs" Inherits="TeacherManage_UnusualManage" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#prev").click(function () {
              ...
              window.location = "UnusualManage.aspx?pageNumber=" + page + "&para=" + $("#para").val();
            ...
            $("#next").click(function () {
                var page = parseInt(<%= pageNumber+1%>)
              window.location.href = "UnusualManage.aspx?pageNumber=" + page + "&para=" + $("#para").val();

          })

            //查询
            $("#querty_btn").click(function () {
                window.location.href = "UnusualManage.aspx?pageNumber=" + 1 + "&para=" + $("#para").val();
            })
            ...
            $("#turnTo").click(function () {
              ...
              window.location.href = "UnusualManage.aspx?pageNumber=" + targetPage + "&para=" + $("#para").val();
          })
            ...
            $(".checkStu").click(function () {
                ...
                var page = parseInt(<%= pageNumber+1%>)
              window.location.href = "UnusualManage.aspx?pageNumber=" + page
            ...
            $("#allCheck").click(function () {
                ...
                $("#UnusualManageStu").find("input:checkbox").each(function () {
            ...
            $("#checkInStu").click(function () {
                var flag = 1;
                var cks = $("#UnusualManageStu").find("input:checkbox:checked");
                if (cks.length <= 0)
                    infoAlert("请选择考生");
                else {
                    if (confirm("确定重置考试状态？")) {
    ...
    <form id="form1" action="UnusualManage.aspx" method="post" runat="server">
        <div>
            ...
            <div style="margin-bottom: 10px; padding: 8px 0 8px 15px; background-color: #F5F5F5">
                ...
                <a href="#" style="color: red">考试异常处理</a> 
            </div>

            <table class="table  table-hover table-bordered table-striped" id="UnusualManageStu">
                <caption>
                    <h3 style="text-align: center"><b><%= examTitle %></b></h3>
                    <%-- <%= UnusualManage.ExamId %>--%>
                </caption>
                <thead>
                    <tr class="info">
                        <td></td>
