<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WaitCheckStu.aspx.cs" Inherits="InvigilateTeacher_WaitCheckStu" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#prev").click(function () {
                ...
                window.location = "WaitCheckStu.aspx?pageNumber=" + page + "&para=" + $("#para").val();
            ...
            $("#next").click(function () {
                var page = parseInt(<%= pageNumber+1%>)
                window.location.href = "WaitCheckStu.aspx?pageNumber=" + page + "&para=" + $("#para").val();

            })

            //查询
            $("#querty_btn").click(function () {
                window.location.href = "WaitCheckStu.aspx?pageNumber=" + 1 + "&para=" + $("#para").val();
            })
            ...
            $("#turnTo").click(function () {
                ...
                window.location.href = "WaitCheckStu.aspx?pageNumber=" + targetPage + "&para=" + $("#para").val();
            })
            ...
            $(".checkStu").click(function () {
                ...
                var page = parseInt(<%= pageNumber+1%>)
                window.location.href = "WaitCheckStu.aspx?pageNumber=" + page
            ...
            $("#checkInStu").click(function () {
                ...
                if (cks.length <= 0)
                    ...
                    window.location.href = window.location.href = "WaitCheckStu.aspx?pageNumber=" + nowPage
    ...
    <form id="form1" runat="server">
        <div>
            <ul class="nav nav-tabs" style="padding-left: 10px; margin-bottom: 5px; margin-top: 5px; font-weight: bolder;">
                <li class="active"><a style="color: red" href="WaitCheckStu.aspx">待登记考生</a></li>
                <li><a href="PassCheckStu.aspx">已登记考生</a></li>
            </ul>
        </div>
        ...
        <table class="table table-striped table-hover table-bordered" id="stuTab">
            ...
            <%if (waitCheckStu != null)
              {%>
            <% int index = 0; %>
            <%foreach (var item in waitCheckStu)
              { %>
            <tr>
                <td>
        ...
        <button type="button" id="checkInStu" class="btn btn-primary btn-sm">登记考生</button>
